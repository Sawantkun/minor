    ...
    <div className="px-6 py-2 pb-[100px] ml-[310px] w-full">
      ...
      <div className="flex justify-between items-center mb-10 border-b-[1px] pb-6">
        ...
        <div className="flex items-center gap-4">
         ...
         <div  className="border border-gray-300 rounded-lg px-4 py-2 outline-none cursor-pointer text-xl cursor bg-gray-300">
      ...
      <div className="grid grid-cols-4 gap-10 ">
        {users.map((user) => (
          ...
          >
            ...
            <button className="bg-purple text-white px-4 py-3 rounded-lg w-[120px] border border-purple font-medium hover:bg-transparent  hover:text-purple hover:border hover:border-purple transition-all duration-300">
                                        Visit Profile
</button>
              ...
              <button className="text-purple-600 hover:text-purple-800">
<img className="w-7" src={MessagesImg} alt="" />              </button>
            </div>
          </div>
        ))}
      </div>
